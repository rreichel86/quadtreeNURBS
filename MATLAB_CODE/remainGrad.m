...
numSeedingPoints_splitt = length(newSeedingPoints_splitt(:,1));
...
if isempty(newSeedingPoints_merge) == 0
    
    %seedingPoints_merge = [isec, isec0, idxLeaf, xcoor, ycoor,pgrad,qgrad]
    numSeedingPoints_merge = length(newSeedingPoints_merge(:,1));
