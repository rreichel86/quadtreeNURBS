...
for i=2:l
    ...
    for j=1:length(Current)/2
        ...
        if aux==[1 1];Location{i}=[Location{i} 1];end
        if aux==[2 1];Location{i}=[Location{i} 2];end
        if aux==[1 2];Location{i}=[Location{i} 3];end
        if aux==[2 2];Location{i}=[Location{i} 4];end                  
    end    
end
end