...
elseif nro == 4
    ...
    degree = 3;
    controlPoints = [0  -5  -20 -20 -10 0 15 20 20 15  5  0;...
                    -5   -8   -2   2   8 7  5  2 -2 -5 -2 -5];

    knots = [0 0 0 0 0.125 0.25 0.375 0.5 0.5 0.625 0.75 0.875 1 1 1 1];
    weights = [1 1 0.7 0.7 1 1 0.7 1 1 0.7 1 1];
